...
jan <- read_csv("~/Case Study/bike_trip2022/Materials/csv/january2022.csv", show_col_types = FALSE)
feb <- read_csv("~/Case Study/bike_trip2022/Materials/csv/february2022.csv", show_col_types = FALSE)
mar <- read_csv("~/Case Study/bike_trip2022/Materials/csv/march2022.csv", show_col_types = FALSE)
apr <- read_csv("~/Case Study/bike_trip2022/Materials/csv/april2022.csv", show_col_types = FALSE)
may <- read_csv("~/Case Study/bike_trip2022/Materials/csv/may2022.csv", show_col_types = FALSE)
jun <- read_csv("~/Case Study/bike_trip2022/Materials/csv/june2022.csv", show_col_types = FALSE)
jul <- read_csv("~/Case Study/bike_trip2022/Materials/csv/july2022.csv", show_col_types = FALSE)
aug <- read_csv("~/Case Study/bike_trip2022/Materials/csv/august2022.csv", show_col_types = FALSE)
sep <- read_csv("~/Case Study/bike_trip2022/Materials/csv/september2022.csv", show_col_types = FALSE)
oct <- read_csv("~/Case Study/bike_trip2022/Materials/csv/october2022.csv", show_col_types = FALSE)
nov <- read_csv("~/Case Study/bike_trip2022/Materials/csv/november2022.csv", show_col_types = FALSE)
dec <- read_csv("~/Case Study/bike_trip2022/Materials/csv/december2022.csv", show_col_types = FALSE)
